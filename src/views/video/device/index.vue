                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item prop="lightPoleId" label="绑定灯杆">
                                <el-select placeholder="请选择灯杆" v-model="form.lightPoleId" style="width:100%" :disabled="state == 'view'"></el-select>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </div>
                        ...
                        <el-col :span="8">
                         ...
                         <el-col :span="8">
                            <el-form-item prop="deviceCategory" label="分类">
                                <el-select placeholder="请选择分类" v-model="form.deviceCategory" style="width:100%" :disabled="state == 'view'">
                                    <el-option
                                        v-for="dict in dict.type.sys_video_type"
                                        :key="dict.value"
                                        :label="dict.label"
