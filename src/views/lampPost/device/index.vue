<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
            ...
            <el-form-item label="挂载设备" prop="road">
                <el-input
                    v-model="queryParams.road"
                    placeholder="请选择挂载设备"
                    clearable
        ...
        <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="挂载设备数" align="center" prop="uid" />
            <el-table-column label="挂载设备类型" align="center" prop="uid" />
            <el-table-column label="挂载率%" align="center" prop="uid" />
            <el-table-column label="倾斜角度" align="center" prop="uid" />
